...
// import { discountedPrice } from "../../common/constant";
  ...
  return (
    <Fragment>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 gap-x-8 gap-y-2 lg:grid-cols-5">
          <div className="lg:col-span-3">
            ...
            >
                ...
                <div className="mb-4">
                  ...
                  <ul role="list" className="divide-y divide-gray-100">
                    {user.addresses.map((address, index) => (
                      <li
                        key={index}
                        className="flex justify-between gap-x-6 py-5 px-3 border-dashed border-2 border-gray"
                      >
              ...
              <div className="mt-6 flex items-center justify-end gap-x-6">
                ...
                <button
                  type="submit"
                  className="rounded-md bg-slate-900 px-3 py-2 text-md font-semibold text-white shadow-sm hover:bg-slate-5800 "
                >
                  Save
                </button>
              </div>
          ...
          <div className="lg:col-span-2">
            <div className="mx-auto mt-12 bg-white max-w-7xl px-4">
              ...
              <div className="border-t border-gray-200 px-2 py-6 sm:px-2">
                ...
                <div className="mt-2">
                  <div
                    onClick={handleOrder}
                    className="flex items-center cursor-pointer justify-center rounded-md border border-transparent bg-slate-900 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-slate-800"
                  >
                    Order Now
                  </div>
                </div>
                ...
                <div className="mt-6 flex justify-center text-center text-sm text-gray-500">
                  <p>
                    ...
                    <Link to="/">
                      <button
                        type="button"
                        className="font-medium nl-1 text-indigo-600 hover:text-indigo-500"
                      >
                        Continue Shopping
                        <span aria-hidden="true"> &rarr;</span>
                      </button>
